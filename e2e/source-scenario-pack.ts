...
export const SOURCE_SCENARIO_PACK: readonly SourceScenarioDefinition[] = [
  ...
  },
  {
    ...
    name: 'Super Hard',
    purpose:
      'Hard but still useful stress case: narrow lot plus moderately overloaded family program to pressure geometry and circulation without becoming absurd.',
    mutate: (source) => {
      setMeta(
        source,
        'super-hard',
        'Super Hard',
        'Narrow-lot, moderate-overload scenario intended to stay in the hard-but-still-informative range instead of collapsing into an obviously impossible brief.',
      );
      setProgram(source, {
        foyer: 1,
        living: 1,
